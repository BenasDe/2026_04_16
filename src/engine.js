...
class GameEngine {
  ...
  initScene() {
    ...
    // Add Large 3D Inverted White Logo Plane on the ground
    this.initLogoPlane();
  }

  /**
   * Loads logo.png, inverts black graphics to glowing white, and displays it largely on the 3D ground.
   */
  initLogoPlane() {
    const img = new Image();
    img.src = 'logo.png';
    img.onload = () => {
      try {
        ...
        // Invert black logo pixels to luminous white
